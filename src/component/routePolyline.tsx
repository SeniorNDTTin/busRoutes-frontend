...
interface RoutePolylineProps {
    ...
    routeData: IBusRoute | IOtherRoutes,
    currentLocation:{ latitude: number; longitude: number; } | null

  }
  
  
  const RoutePolyline = ({ colors ,busRouteId, route, routeData, currentLocation }: RoutePolylineProps) => {
    ...
    return (
      <Polyline
        ...
        eventHandlers={{
          click: () => {
            navigate(`/detailRoute/${busRouteId}`, {
              state: { 
                routeData : routeData as IBusRoute,
